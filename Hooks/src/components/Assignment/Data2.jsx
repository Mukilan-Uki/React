...
export default function Data() {
  ...
  // Handles clicking "View" and updating multiple states
  const handleView = (student) => {
    setFinalStudent(student);       // show student details
    setFontSize("18px");            // optional: change font size
    setImgSize("200px");            // optional: change image size
  };
  ...
  return (
    <>
      ...
      {/* Student details show only after clicking "View" */}
      {finalStudent && (
        <div className="d-flex" style={{ marginTop: "20px" }}>
          <img src={finalStudent.image} alt={finalStudent.name} style={{ width: imgSize }} />
          <div className="details" style={{ fontSize: fontSize, marginLeft: "20px" }}>
